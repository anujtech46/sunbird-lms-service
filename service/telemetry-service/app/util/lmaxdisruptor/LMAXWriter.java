...
/**
 * @author Manzarul 
 * A class to control the disruptor engine. It initialize the disruptor, submits
...
public class LMAXWriter {
  ...
  private void init() {
    ...
    disruptor = new Disruptor<TelemetryEvent>(factory, ringBufferSize, executor);
    disruptor.handleEventsWith(handler,ekstepHandler);
